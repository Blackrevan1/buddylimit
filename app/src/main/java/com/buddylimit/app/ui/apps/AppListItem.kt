...
/** One row in the app picker: an installed app annotated with its monitor state. */
...
/**
 * Pure merge of the live installed-app list with the persisted monitored set.
 * Free of Android deps so it is unit-testable. The list is driven by installed apps,
